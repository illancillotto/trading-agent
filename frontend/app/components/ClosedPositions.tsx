                ...
                {trades.map(trade => (
                    <div key={trade.id} className="bg-white border rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
                        <div className="flex justify-between items-start mb-3">
                            ...
                            <span className={`px-2 py-0.5 rounded text-xs font-bold uppercase ${trade.direction === 'long' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                                }`}>
                                {trade.direction}
                            </span>
                        </div>
                        ...
                        <div className="flex justify-between items-end pt-2 border-t border-gray-100">
                            ...
                            <div className={`font-bold ${(trade.pnl_usd || 0) >= 0 ? 'text-green-600' : 'text-red-600'
                                }`}>
