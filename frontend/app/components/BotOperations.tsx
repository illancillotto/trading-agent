        ...
        return (
          ...
          >
            ...
            <div className="flex gap-2 flex-wrap mb-4">
              ...
              {op.direction && (
                <span className={`px-3 py-1 rounded-full border text-xs font-medium ${op.direction.toLowerCase() === 'long'
            ...
            {reason && (
              <div className="mb-3">
                <p className="text-sm text-gray-700 leading-relaxed">
                  {reason.length > 280 && !expandedReasons.has(op.id) ? (
                    <>
                      {truncate(reason, 280)}
                      <button
                    ...
                    <>
                      ...
                      {reason.length > 280 && (
                        <button
                          onClick={() => toggleReason(op.id)}
                          className="ml-1 text-blue-600 hover:underline text-xs font-medium block mt-1"
                        >
                          ‹ Nascondi
                        </button>
                      )}
